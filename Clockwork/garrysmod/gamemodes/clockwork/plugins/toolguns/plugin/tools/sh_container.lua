...
if CLIENT then
	...
	local function AddDefControls( Panel )
		...
		if ( mode == 1 ) then 
			Panel:AddControl( "Slider",  { Label	= "Item Fill Scale",
					Type	= "Interger",
					Min		= 1,
					Max		= 5,
			...
			Panel:AddControl( "TextBox", { Label = "Category",
									 MaxLenth = "20",
		...
		if ( mode == 2 ) then 
			...
			Panel:AddControl( "TextBox", { Label = "Message",
									 MaxLenth = "20",
		...
		if ( mode == 3) then 
			...
			Panel:AddControl( "TextBox", { Label = "Name",
									 MaxLenth = "20",
		...
		if ( mode == 4) then 
			...
			Panel:AddControl( "TextBox", { Label = "Password",
									 MaxLenth = "20",
