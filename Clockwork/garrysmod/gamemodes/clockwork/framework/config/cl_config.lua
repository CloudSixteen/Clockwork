...
Clockwork.config:AddToSystem("Physical Description Cutoff", "phys_desc_cutoff", "The amount of characters of a character's physical description to display.", 125, 300);
